 ...
 * 
 */
public class PlayerInjuryXMLReader extends XMLMatchableReader<Movie, Attribute>  {
	...
	public Movie createModelFromElement(Node node, String provenanceInfo) {
		String playerName = getValueFromChildElement(node, "playerName");
        String teamName = getValueFromChildElement(node, "teamName");
        String position = getValueFromChildElement(node, "position");
        String injuryNotes = getValueFromChildElement(node, "injuryNotes");
