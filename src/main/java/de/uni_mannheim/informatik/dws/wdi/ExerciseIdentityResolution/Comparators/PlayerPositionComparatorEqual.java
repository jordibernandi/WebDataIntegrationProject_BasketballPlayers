...
public class PlayerPositionComparatorEqual implements Comparator<PlayerStat, Attribute> {
    ...
    @Override
    public double compare(PlayerStat record1, PlayerInjury record2, Correspondence<PlayerDBpedia, Matchable> schemaCorrespondence) {
    	int s1 = record1.getPositions();
    	int s2 = record1.getPosition();
