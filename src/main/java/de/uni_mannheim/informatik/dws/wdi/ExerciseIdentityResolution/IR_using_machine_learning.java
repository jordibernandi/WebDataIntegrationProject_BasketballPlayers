...
public class IR_using_machine_learning {
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        gsTrainingPlayerStatDBpedia.loadFromCSVFile(new File("data/goldstandard/player_stat_2_dbpedia_train.csv"));
        gsTrainingPlayerStatSalary.loadFromCSVFile(new File("data/goldstandard/player_stat_2_salary_train.csv"));
        gsTrainingPlayerStatInjury.loadFromCSVFile(new File("data/goldstandard/player_stat_2_injury_train.csv"));
...
//        matchingRuleRealPred.activateDebugReport("data/output/debugResultsMatchingRule.csv", 1000, gsTrainingRealPred);
        ...
        WekaMatchingRule<Player, Attribute> matchingRulePlayerStatSalary = new WekaMatchingRule<>(0.75, modelType, options);
//        matchingRulePlayerStatInjury.activateDebugReport("data/output/debugResultsMatchingRulePredFifa.csv", 1000, gsTrainingPredFifa);

        WekaMatchingRule<Player, Attribute> matchingRulePlayerStatInjury = new WekaMatchingRule<>(0.75, modelType, options);
//      matchingRulePlayerStatInjury.activateDebugReport("data/output/debugResultsMatchingRule.csv", 1000, gsTrainingRealFifa);
		...
		matchingRulePlayerStatSalary.addComparator(new PlayerNameComparatorJaccardTokenizer());
        ...
        gsTestPlayerStatDBpedia.loadFromCSVFile(new File("data/goldstandard/player_stat_2_dbpedia_test.csv"));
        gsTestPlayerStatSalary.loadFromCSVFile(new File("data/goldstandard/player_stat_2_salary_test.csv"));
        gsTestPlayerStatInjury.loadFromCSVFile(new File("data/goldstandard/player_stat_2_injury_test.csv"));
